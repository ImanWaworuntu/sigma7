  ...
  return (
    <main className="flex-1 overflow-y-auto bg-slate-50 pb-24">
      ...
      <div className="px-6 mt-6">
        ...
        <div className={`grid gap-3 ${user?.role === 'admin' ? 'grid-cols-5' : 'grid-cols-3'}`}>
          ...
          {user?.role === 'admin' && (
            <>
              <Link href="/log" className="bg-white/80 backdrop-blur-sm border border-slate-200 rounded-2xl p-2 flex flex-col items-center justify-center shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 active:scale-95 group">
                <div className="bg-amber-50 text-amber-600 h-10 w-10 rounded-full flex items-center justify-center mb-1 group-hover:bg-amber-100 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>
                </div>
                <span className="font-bold text-slate-700 text-[10px] text-center">Log</span>
              </Link>
